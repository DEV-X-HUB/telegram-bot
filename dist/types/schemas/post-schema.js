...
exports.DateSchema = exports.ExpireDateSchema = exports.IssueDateSchema = exports.ConfirmationYearSchema = exports.lastDititSchema = exports.locationSchema = exports.titleSchema = exports.descriptionSchema = exports.TextSchema = void 0;
...
const TextSchema = ({ wordLength = 15, textName, allowSpecialCharacter = false, }) => zod_1.default.string().refine((value) => {
...
exports.descriptionSchema = (0, exports.TextSchema)({
...
exports.locationSchema = (0, exports.TextSchema)({ textName: 'Sub city or Location', wordLength: locationMaxLetters });
