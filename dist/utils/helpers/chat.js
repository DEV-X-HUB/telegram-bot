...
const sendMessageNotificationOnPost = (_b) => __awaiter(void 0, [_b], void 0, function* ({ bot, message, chatId, post_id, }) {
    return yield bot.telegram.sendMessage(chatId, message, {
        parse_mode: 'HTML',
        reply_markup: {
            inline_keyboard: [[{ text: 'Show me', url: `${config_1.default.bot_url}?start=postDetail_${post_id}` }]],
        },
    });
});
