...
const areEqaul = (text1, text2, ignoreCase) => {
    if (ignoreCase)
        return (text1 === null || text1 === void 0 ? void 0 : text1.toLocaleLowerCase().trim()) == (text2 === null || text2 === void 0 ? void 0 : text2.toLocaleLowerCase().trim());
    return (text1 === null || text1 === void 0 ? void 0 : text1.trim()) == (text2 === null || text2 === void 0 ? void 0 : text2.trim());
};
exports.areEqaul = areEqaul;
const formatNumberWithCommas = (num) => {
    var _a;
    return (_a = num === null || num === void 0 ? void 0 : num.toString()) === null || _a === void 0 ? void 0 : _a.replace(/\B(?=(\d{3})+(?!\d))/g, ',');
};
